...
export const trace = (namespace: string): Debugger => debug(`WorldCerts-website:trace:${namespace}`);
export const error = (namespace: string): Debugger => debug(`WorldCerts-website:error:${namespace}`);
