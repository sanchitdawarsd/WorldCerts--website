...
export const faqContent: FagElement[] = [
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: (
          <>
            OpenCerts is the umbrella trademark under which we have released a few key components: <br />
            <ol>
              <li>
...

  {
    ...
    faq: [
      ...
      },
      {
        ...
        question: 'What does it mean by "Certificate issuer is not in the SkillsFuture  registry for Worldcerts"?',
        answer: (
          <ul>
            <li>
