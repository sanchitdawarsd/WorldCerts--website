...
const aboutImages = {
    ...
    <i aria-hidden="true">
      <svg xmlns="http://www.w3.org/2000/svg" width="73.4" height="83.15" viewBox="0 0 73.4 83.15">
        ...
        <path
          ...
          fill="url(#b)"
        />{" "}
        <rect x="23" y="29.77" width="28.5" height="26.2" fill="#fff" />
        <path
  ...
  two: () => (
    <i aria-hidden="true">
      <svg xmlns="http://www.w3.org/2000/svg" width="129" height="137" viewBox="0 0 129 137">
        ...
        <title>two</title>
        <path d="M0,0H129V137H0Z" fill="#edf2f7" />
        <g>
          <g>
            <path
  ...
  three: () => (
    <i aria-hidden="true">
      ...
      {/* <svg xmlns="http://www.w3.org/2000/svg" width="246.6" height="127" viewBox="0 0 246.6 127">
        <defs>
          <linearGradient id="threea" x1="-168.98" y1="373.08" x2="-168.98" y2="374.08" gradientTransform="matrix(68.19, 0, 0, -85.18, 11562.95, 31905.14)" gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor="#faa94e"/>
            <stop offset="1" stopColor="#f47d4d"/>
          </linearGradient>
          <linearGradient id="threeb" x1="-168.95" y1="372.98" x2="-168.95" y2="374.06" gradientTransform="matrix(67.38, 0, 0, -83.57, 11420.15, 31294.43)" xlinkHref="#threea"/>
          <linearGradient id="threec" x1="-166.84" y1="358.86" x2="-166.84" y2="360.21" gradientTransform="matrix(36.9, 0, 0, -14.68, 6192.23, 5341.07)" xlinkHref="#threea"/>
          <linearGradient id="threed" x1="-168.76" y1="373.29" x2="-169.23" y2="373.91" gradientTransform="matrix(68.19, 0, 0, -85.18, 11734.95, 31905.14)" gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor="#00a8d4"/>
            <stop offset="1" stopColor="#007aa9"/>
          </linearGradient>
          <linearGradient id="threee" x1="-169.34" y1="373.23" x2="-168.84" y2="374" gradientTransform="matrix(67.38, 0, 0, -83.57, 11592.15, 31294.43)" xlinkHref="#threed"/>
        ...
        <g>
          <g opacity="0.58">
            <path d="M89.4,52h69.2" transform="translate(-0.4)" fill="none" stroke="#979797" stroke-linecap="square" strokeWidth="0.8"/>
            <polyline points="92.58 48.41 88.6 52.09 92.58 55.77" fill="none" stroke="#979797" stroke-linecap="square" strokeWidth="0.8"/>
            <polyline points="154.62 48.41 158.6 52.09 154.62 55.77" fill="none" stroke="#979797" stroke-linecap="square" strokeWidth="0.8"/>
          </g>
          <g opacity="0.58">
            <path d="M89.4,66.48h69.2" transform="translate(-0.4)" fill="none" stroke="#979797" stroke-linecap="square" strokeWidth="0.8"/>
            <polyline points="92.58 62.86 88.6 66.54 92.58 70.22" fill="none" stroke="#979797" stroke-linecap="square" strokeWidth="0.8"/>
            <polyline points="154.62 62.86 158.6 66.54 154.62 70.22" fill="none" stroke="#979797" stroke-linecap="square" strokeWidth="0.8"/>
          </g>
          <g opacity="0.58">
            <path d="M89.4,81.73h69.2" transform="translate(-0.4)" fill="none" stroke="#979797" stroke-linecap="square" strokeWidth="0.8"/>
            <polyline points="92.58 78.12 88.6 81.8 92.58 85.48" fill="none" stroke="#979797" stroke-linecap="square" strokeWidth="0.8"/>
            <polyline points="154.62 78.12 158.6 81.8 154.62 85.48" fill="none" stroke="#979797" stroke-linecap="square" strokeWidth="0.8"/>
          </g>
          <g opacity="0.58">
            <path d="M89.4,95.39h69.2" transform="translate(-0.4)" fill="none" stroke="#979797" stroke-linecap="square" strokeWidth="0.8"/>
            <polyline points="92.58 91.77 88.6 95.39 92.58 99" fill="none" stroke="#979797" stroke-linecap="square" strokeWidth="0.8"/>
            <polyline points="154.62 91.77 158.6 95.39 154.62 99" fill="none" stroke="#979797" stroke-linecap="square" strokeWidth="0.8"/>
          </g>
          <g>
            <path d="M130.14,47.31,123,54.61a.76.76,0,0,1-1.07,0l-4-4.1a.76.76,0,0,1,0-1.08.74.74,0,0,1,1.06,0l3.5,3.56,6.66-6.77a.75.75,0,0,1,1.06,0A.77.77,0,0,1,130.14,47.31Z" transform="translate(-0.4)" fill="#09a63b" stroke="#09a63b" strokeWidth="0.64"/>
            <path d="M130.14,61.76,123,69.06a.74.74,0,0,1-1.07,0l-4-4.1a.76.76,0,0,1,0-1.08.74.74,0,0,1,1.06,0l3.5,3.56,6.66-6.76a.74.74,0,0,1,1.06,0A.76.76,0,0,1,130.14,61.76Z" transform="translate(-0.4)" fill="#09a63b" stroke="#09a63b" strokeWidth="0.64"/>
            <path d="M130.14,76.22,123,83.52a.76.76,0,0,1-1.07,0l-4-4.1a.76.76,0,0,1,0-1.08.74.74,0,0,1,1.06,0l3.5,3.55,6.66-6.76a.74.74,0,0,1,1.06,0A.77.77,0,0,1,130.14,76.22Z" transform="translate(-0.4)" fill="#09a63b" stroke="#09a63b" strokeWidth="0.64"/>
            <path d="M130.14,89.87,123,97.17a.76.76,0,0,1-1.07,0l-4-4.1a.76.76,0,0,1,0-1.08.74.74,0,0,1,1.06,0l3.5,3.56,6.66-6.77a.75.75,0,0,1,1.06,0A.77.77,0,0,1,130.14,89.87Z" transform="translate(-0.4)" fill="#09a63b" stroke="#09a63b" strokeWidth="0.64"/>
          </g>
        </g>
        <g>
          <path d="M57.22,127h-47a3.49,3.49,0,0,1-3.38-3.43V45.26a3.49,3.49,0,0,1,3.38-3.44H71.62A3.49,3.49,0,0,1,75,45.26v66.63" transform="translate(-0.4)" opacity="0.15" fill="url(#threea)" />
          <path d="M51.82,120.57H5.34A3.3,3.3,0,0,1,2,117.2V40.37A3.44,3.44,0,0,1,5.34,37H66.05a3.43,3.43,0,0,1,3.33,3.37v65.37" transform="translate(-0.4)" fill="none" strokeWidth="3.2" stroke="url(#threeb)"/>
          <path d="M17.24,56.29h36.9M17.24,71h36.9" transform="translate(-0.4)" fill="none" strokeWidth="3.2" stroke="url(#threec)"/>
        </g>
        <g>
          <path d="M229.22,127h-47a3.49,3.49,0,0,1-3.38-3.43V45.26a3.49,3.49,0,0,1,3.38-3.44h61.43A3.49,3.49,0,0,1,247,45.26v66.63" transform="translate(-0.4)" opacity="0.15" fill="url(#threed)" />
          <path d="M223.82,120.57H177.34A3.3,3.3,0,0,1,174,117.2V40.37A3.44,3.44,0,0,1,177.34,37h60.71a3.43,3.43,0,0,1,3.33,3.37v65.37" transform="translate(-0.4)" fill="none" strokeWidth="3.2" stroke="url(#threee)"/>
          <path d="M189.24,56.29h36.9M189.24,71h36.9" transform="translate(-0.4)" fill="none" strokeWidth="3.2" stroke="url(#threef)"/>
        </g>
        <g>
          <line x1="34.84" y1="37" x2="34.84" fill="#fff"/>
          <g>
            <line x1="34.84" y1="37" x2="34.84" y2="35" fill="none" stroke="url(#threeg)"/>
            <line x1="34.84" y1="31.33" x2="34.84" y2="3.83" fill="none" strokeDasharray="3.67 3.67" stroke="url(#threeg)"/>
            <line x1="34.84" y1="2" x2="34.84" fill="none" stroke="url(#threeg)"/>
          </g>
        </g>
        <g>
          <line x1="207.29" y1="37" x2="207.29" fill="#fff"/>
          <g>
            <line x1="207.29" y1="37" x2="207.29" y2="35" fill="none" stroke="url(#threej)"/>
            <line x1="207.29" y1="31.33" x2="207.29" y2="3.83" fill="none" strokeDasharray="3.67 3.67" stroke="url(#threej)"/>
            <line x1="207.29" y1="2" x2="207.29" fill="none" stroke="url(#threej)"/>
          </g>
        </g>
      </svg> */}
    </i>
